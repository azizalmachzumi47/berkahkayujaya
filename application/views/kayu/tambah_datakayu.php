    ...
    <div class="container-fluid dashboard-content">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <form action="<?= base_url(); ?>kayu/tambahdata_kayuaction" method="post" class="form-horizontal"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                <textarea name="keterangan_kayu" id="keterangan_kayu" class="form-control" rows="5"
