    ...
    <div class="container-fluid dashboard-content">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <form action="<?= base_url('kegiatan/editkegiatan_action/' . $kegiatankayu->id_kegiatan); ?>"
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                <textarea name="deskripsi_kegiatan" id="deskripsi_kegiatan" class="form-control"
                                    rows="5"><?= $kegiatankayu->deskripsi_kegiatan ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="col-sm-8">
                            <div class="form-group">
                                <img src="<?= base_url('assets/gambarkegiatan/' . $kegiatankayu->upload_kegiatan) ?>"
